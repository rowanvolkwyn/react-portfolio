    ...
    return (
        ...
        >
            ...
            <div className="z-30 basis 2/5 mt:12 md:mt-32">
                ...
                >
                    <p className="text-6xl font-playfair z-10 text-center md:text-start">                            Rowan {""}
                        <span
                ...
                <motion.div
                    ...
                    transition={{ delay: 0.2, duration: 0.5 }}                        transition={{ duration: 0.5 }}
                    variants={{
                        hidden: { opacity: 0, x: -50},
                        visible: { opacity: 1, x: 0}
                    }}
                >
                    ...
                    <AnchorLink
                        ...
                        href="#contact"
                    >
                        <div className="bg-deep-blue hover:text-red transition duration-500 w-full
                ...
                <motion.div
                    ...
                    whileInView="visible"
                    viewport={{ once: true, amount: 0.5 }}
                    transition={{ delay: 0.4, duration: 0.5 }}                        transition={{ duration: 0.5 }}
                    variants={{
                        hidden: { opacity: 0, x: -50},
                        visible: { opacity: 1, x: 0}
                    }}
